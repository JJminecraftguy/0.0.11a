...
public class Zombie extends Entity {
	...
	public void render(float a) {
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.textures.loadTexture("/char.png", GL11.GL_LINEAR));
		GL11.glPushMatrix();
		...
		GL11.glTranslatef(this.xo + (this.x - this.xo) * a, this.yo + (this.y - this.yo) * a - this.heightOffset, this.zo + (this.z - this.zo) * a);
